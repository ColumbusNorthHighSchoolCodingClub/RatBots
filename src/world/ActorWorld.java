...
public class ActorWorld extends World<RatBotActor>
{    
     ...
     */
    public ActorWorld(Grid<RatBotActor> grid)
    {
        super(grid);
    }
     ...
     */
    public void add(Location loc, RatBotActor occupant)
    {
     ...
     */
    public void add(RatBotActor occupant)
    {
     ...
     * location.
     */
    public RatBotActor remove(Location loc)
    {
        RatBotActor occupant = getGrid().get(loc);
        if (occupant == null)
            return null;
